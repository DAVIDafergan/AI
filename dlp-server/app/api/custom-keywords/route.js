...
export async function GET(request) {
  try {
    ...
    const keywords = await getCustomKeywords(organizationId);
...
export async function POST(request) {
  try {
    ...
    const saved = await saveCustomKeyword(organizationId, {
      word: word.trim(),
...
export async function DELETE(request) {
  try {
    ...
    const remaining = await deleteCustomKeyword(organizationId, id);
